...
export const tasks = {
  ...
  bitcoin_mining: {
    ...
    baseEarningsPerHour: 125, earningsScalingFactor: 0.8,
  ...
  ethereum_mining: {
    ...
    baseEarningsPerHour: 100, earningsScalingFactor: 0.7,
  ...
  altcoin_mining: {
    ...
    baseEarningsPerHour: 75, earningsScalingFactor: 0.5,
  ...
  ai_training: {
    ...
    baseEarningsPerHour: 500, earningsScalingFactor: 1.2,
  ...
  protein_folding: {
    ...
    baseEarningsPerHour: 200, earningsScalingFactor: 0.6,
  ...
  game_server: {
    ...
    baseEarningsPerHour: 300, earningsScalingFactor: 0.7,
  ...
  stock_bot: {
    ...
    baseEarningsPerHour: 250, earningsScalingFactor: 0.9,
  ...
  render_farm: {
    ...
    baseEarningsPerHour: 400, earningsScalingFactor: 1.0,
  ...
  weather_ai: {
    ...
    baseEarningsPerHour: 625, earningsScalingFactor: 1.1,
  ...
  deepfake_factory: {
    ...
    baseEarningsPerHour: 550, earningsScalingFactor: 1.0,
  ...
  dark_web_server: {
    ...
    baseEarningsPerHour: 750, earningsScalingFactor: 0.8,
  ...
  quantum_sim: {
    ...
    baseEarningsPerHour: 2000, earningsScalingFactor: 1.5,
  ...
  genome_sequencing: {
    ...
    baseEarningsPerHour: 875, earningsScalingFactor: 1.2,
  ...
  nft_minting: {
    ...
    requirements: { minCpuScore: 0, minGpuScore: 3.0, minRamScore: 0, minCombinedScore: 0 },
    baseEarningsPerHour: 175, earningsScalingFactor: 0.6,
  ...
  satellite_comms: {
    ...
    baseEarningsPerHour: 1125, earningsScalingFactor: 1.3,
  ...
  neural_net_god: {
    ...
    baseEarningsPerHour: 5000, earningsScalingFactor: 2.0,
  ...
  universe_sim: {
    ...
    baseEarningsPerHour: 25000, earningsScalingFactor: 3.0,
