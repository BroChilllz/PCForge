...
export const tasks = {
  ...
  bitcoin_mining: {
    ...
    baseEarningsPerHour: 125, earningsScalingFactor: 20,
  ...
  ethereum_mining: {
    ...
    baseEarningsPerHour: 100, earningsScalingFactor: 17.5,
  ...
  altcoin_mining: {
    ...
    baseEarningsPerHour: 75, earningsScalingFactor: 12.5,
  ...
  ai_training: {
    ...
    baseEarningsPerHour: 500, earningsScalingFactor: 30,
  ...
  protein_folding: {
    ...
    baseEarningsPerHour: 200, earningsScalingFactor: 15,
  ...
  game_server: {
    ...
    baseEarningsPerHour: 300, earningsScalingFactor: 17.5,
  ...
  stock_bot: {
    ...
    baseEarningsPerHour: 250, earningsScalingFactor: 22.5,
  ...
  render_farm: {
    ...
    baseEarningsPerHour: 400, earningsScalingFactor: 25.0,
  ...
  weather_ai: {
    ...
    baseEarningsPerHour: 625, earningsScalingFactor: 27.5,
  ...
  deepfake_factory: {
    ...
    baseEarningsPerHour: 550, earningsScalingFactor: 25.0,
  ...
  dark_web_server: {
    ...
    baseEarningsPerHour: 750, earningsScalingFactor: 20,
  ...
  quantum_sim: {
    ...
    baseEarningsPerHour: 2000, earningsScalingFactor: 37.5,
  ...
  genome_sequencing: {
    ...
    baseEarningsPerHour: 875, earningsScalingFactor: 30,
  ...
  nft_minting: {
    ...
    requirements: { minCpuScore: 0, minGpuScore: 3.0, minRamScore: 0, minCombinedScore: 0 },
    baseEarningsPerHour: 175, earningsScalingFactor: 15,
  ...
  satellite_comms: {
    ...
    baseEarningsPerHour: 1125, earningsScalingFactor: 32.5,
  ...
  neural_net_god: {
    ...
    baseEarningsPerHour: 5000, earningsScalingFactor: 50.0,
  ...
  universe_sim: {
    ...
    baseEarningsPerHour: 25000, earningsScalingFactor: 75.0,
